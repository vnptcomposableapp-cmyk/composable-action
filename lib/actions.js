...
const sample_create_composable_app_1 = require("sample-create-composable-app");
const gitUserName = "Composable Bot";
const gitUserEmail = "ops+git@composable.app";
class PlasmicAction {
    constructor(args) {
        this.args = args;
        this.opts = {
        ...
        if (args.disableSslVerification) {
            console.log("Warning: SSL certificate verification is disabled for ngrok compatibility.");
            // Set environment variable for Node.js SSL bypass
            process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0";
            // Also set for child processes
            process.env.HTTPS_PROXY_REJECT_UNAUTHORIZED = "0";
            console.log("SSL bypass environment variables set:", {
                NODE_TLS_REJECT_UNAUTHORIZED: process.env.NODE_TLS_REJECT_UNAUTHORIZED,
                HTTPS_PROXY_REJECT_UNAUTHORIZED: process.env.HTTPS_PROXY_REJECT_UNAUTHORIZED,
            });
        }
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            console.log("PlasmicAction running with options:", {
                run: this.args.run,
                disableSslVerification: this.args.disableSslVerification,
                NODE_TLS_REJECT_UNAUTHORIZED: process.env.NODE_TLS_REJECT_UNAUTHORIZED,
            });
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            sample_create_composable_app_1.setMetadata({
                source: "plasmic-action",
            });
            const relTmpDir = "tmp-cpa";
            yield sample_create_composable_app_1.create({
